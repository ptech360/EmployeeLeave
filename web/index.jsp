...
<html lang="en">
    <head>
        <title>Employee MAnagemnet</title>
        <meta charset="utf-8">
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown"><a class="mouse-change glyphicon glyphicon-log-in dropdown-toggle" data-toggle="dropdown" href="#">Login<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a id="ulog" >User</a></li>
                                <li><a id="adlog">Admin</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header" style="padding:35px 50px;">
                        ...
                        <h4 class="glyphicon glyphicon-log-in">Login</h4>
                    </div>
